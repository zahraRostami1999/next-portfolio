...
export default function About() {
  ...
  return (
    <div className="w-full bg-white dark:bg-red-500 lg:py-0 sm:py-10 py-3 flex flex-wrap items-center p-5 h-[90vh] rounded-xl shadow-md border border-neutral-100">
